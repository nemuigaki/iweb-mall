...
public class DoneSate extends AbstractState {
    ...
    public CommonResult cancel(String orderId, Enum<Constants.OrderState> currentState) {
        return CommonResult.failed("交易已完成, 不能取消");
    }
}
